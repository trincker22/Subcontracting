...
ggplot(priors6_summary, aes(x = total_n, y = effective_pscs)) +
  ...
  labs(
    ...
    x = "Number of NAICS–PSC pairs (log scale)",
...
prior6 <- read_parquet(here("Data", "Prior", "Priors", "prior_naics6_psc.parquet"))
